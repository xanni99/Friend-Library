...
class Book(db.Model):
    ...
    loans: Mapped["Loan"] = relationship(back_populates='book', cascade="all, delete-orphan")
    reviews: Mapped["Review"] = relationship(back_populates="book", cascade="all, delete-orphan")
